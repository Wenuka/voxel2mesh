...
def try_twice(function, primary_location, backup_location,  *args):
    try:
        function(primary_location, *args)
    except KeyboardInterrupt:
        raise
    except:
        print("{}".format(sys.exc_info()))
        print("Trying backup disk")

        try:
            function(backup_location, *args)
            print("Resutls saved to backup disk in eval.")
        except KeyboardInterrupt:
            raise
        except:
            print("Bad luck! Error in saving results to backup disk in eval.")
